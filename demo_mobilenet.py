...
def main():
    ...
    parser.add_argument('--ckpt', type=str, default='/home/jieun/pytorch-deeplab-xception/run/morai/deeplab-mobilenet/model_best.pth.tar',
                        help='saved model')
    ...
    parser.add_argument('--dataset', type=str, default='morai',
                        choices=['pascal', 'coco', 'cityscapes', 'morai'],
    ...
    grid_image = make_grid(decode_seg_map_sequence(torch.max(output[:3], 1)[1].detach().cpu().numpy(), dataset='morai'), 
